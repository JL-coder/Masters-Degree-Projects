...
# From http://www.slate.com/articles/sports/sports_nut/2008/03/the_lead_is_safe.html
def main():
    # 1. Take the number of points one team is ahead.
    points_remaining_int = int(input("Enter the lead in points: "))
    ...
    #    the lead is safe.
    seconds_remaining_int = float(input("Enter the number of seconds remaining: "))
